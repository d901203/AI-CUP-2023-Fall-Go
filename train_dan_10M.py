...
def train(
    ...
    for epoch in tqdm(range(1, epochs + 1)):
        ...
        if valid_accuracy > best_accuracy:
            ...
            torch.save(model.state_dict(), "./checkpoints/dan_10M_best_model.pth")
...
def load_data(train_size=0.8, batch_size=512):
    ...
    target_paths = []
    for i in range(1, 8):
        data_paths.append(f"./data/dan/10M/train_x_{i}.npz")
        target_paths.append(f"./data/dan/10M/train_y_{i}.npz")
