...
def train(
    ...
    for epoch in tqdm(range(1, epochs + 1)):
        ...
        if valid_accuracy > best_accuracy:
            ...
            torch.save(model.state_dict(), "./checkpoints/play_style_best_model.pth")
...
def load_data(train_size=0.8, batch_size=256):
    data_paths = ["./data/play_style/train_x.npz"]
    target_paths = ["./data/play_style/train_y.npz"]
